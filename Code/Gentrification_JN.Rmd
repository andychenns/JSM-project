...
```{r Model 2}
#% change in Rent, % change in Income, % change in White, Avg Age
model_2 <- glm(Gentrified ~ Pct_Chg_Income + Pct_Chg_Rent + Pct_Chg_Income*Pct_Chg_Rent + Pct_White + Avg_Age, data = pct_NY, family = "binomial")
summary(model_2)
```
